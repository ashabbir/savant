...
require_relative '../hub/service_manager'
require_relative '../framework/transports/http/rack_app'
    ...
    class HTTPRunner
      ...
      class << self
        ...
        def build_manager(service, logger)
          ...
          Savant::Hub::ServiceManager.new(service: service_name, logger: logger)
        end
