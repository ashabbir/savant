  ...
  module Transport
    ...
    class HTTP
      ...
      def validate_payload!(payload)
        raise BadRequestError, 'Invalid Request' unless payload.is_a?(Hash) && payload['method']
      end
      ...
      def payload_error_response(error, payload)
        ...
        when BadRequestError then [400, json_error(id, -32_600, error.message), :warn, 'request.invalid']
        when UnknownServiceError then [404, json_error(id, -32_601, error.message), :error, 'service.unknown']
