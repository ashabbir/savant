      ...
      module DSL
        ...
        class Builder
          def initialize(policy: nil)
            ...
            @policy = policy || Savant::Logging::Audit::Policy.load
          ...
          def install_framework_middleware
            audit_store = @policy.audit_enabled? ? Savant::Logging::Audit::Store.new(@policy.audit_store_path) : nil
            metrics = Savant::Framework::Middleware::Metrics.new
            trace = Savant::Framework::Middleware::Trace.new(logger_factory: method(:logger_for_ctx),
                                                  metrics: metrics,
